...
namespace XFramework.Core
{
    ...
    public class Mailer
    {
        ...
        private string _adressIsEmpty = "邮件地址为空！";
        private string _adressInvalid = "无效的邮件地址！";
        ...
        private string CheckMailAddress(string address, bool shouldCheckEmpty)
        {
            if (string.IsNullOrEmpty(address))
            {
                ...
                {
                    //邮件地址不能为 null.
                    throw new Exception(_adressIsEmpty);
                }
                else
                {
                    return "";
            ...
            for (int i = 0; i < tos.Length; i++)
            {
                ...
                {
                    //无效的邮件地址.
                    throw new Exception(_adressInvalid + address + "'");
                }
            }

...
namespace XFramework.DataAccess
{
	...
	/// </summary>
    [Serializable]
    [XmlRoot("dataSource", Namespace = "http://ibatis.apache.org/dataSource")]
    public class DataSource : IDataSource
    {
        ...
        [NonSerialized]
        private int _commandTimeout = 900;
        #endregion
        ...
        public string DbProviderName
        {
            ...
            set
            {
                CheckPropertyString("DbProviderName", value);
                _providerName = value;
            }
        }
        ...
        {
            get {
                if (_provider == null) _provider = ConfigHelper.GetProvider(_providerName);

...
namespace ICS.XFramework.Data
{
    ...
    public class ColumnExpressionVisitor : ExpressionVisitorBase
    {
        ...
        /// </summary>
        public ColumnExpressionVisitor(DbQueryProviderBase provider, TableAliasCache aliases, DbExpression exp, DbExpression groupBy = null, bool mOnly = false, IDictionary<string, Column> columns = null)

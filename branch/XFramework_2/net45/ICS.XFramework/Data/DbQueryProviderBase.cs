...
namespace ICS.XFramework.Data
{
    ...
    public abstract partial class DbQueryProviderBase : IDbQueryProvider
    {
        ...
        /// <param name="trans">事务</param>
        /// <returns></returns>
        public T Execute<T>(List<string> sqlList, CommandDefine define = null, IDbTransaction trans = null)
        {
        ...
        /// <param name="trans">事务</param>
        /// <returns></returns>
        public List<T> ExecuteList<T>(List<string> sqlList, CommandDefine define = null, IDbTransaction trans = null)
        {

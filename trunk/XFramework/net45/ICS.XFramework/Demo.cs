...
namespace ICS.XFramework
{
    public class Demo
    {
        ...
        static void Query()
        {
            ...
            var query3 =
                from a in context
                    ...
                    .Include(a => a.Client.AccountList[0].Client)
            ...
            join b in context.GetTable<Inte_CRM.Account>() on a.ClientId equals b.ClientId
        ...
        static void Rabbit()
        {
            ...
            {
                var query =
                    from a in context.GetTable<Inte_CRM.Account>()
                    select new Inte_CRM.Account(a)
                    {
                        Client = new Inte_CRM.Client
                        {
                            ClientId = a.Client.ClientId,
